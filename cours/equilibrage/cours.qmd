...
---
title: "Plans équilibrés en sondage"
format: revealjs
...
- Dans de nombreuses enquêtes, il est souhaitable de respecter certaines **contraintes auxiliaires** (ex: répartition régionale, catégories socio-professionnelles).
- Objectif : obtenir un **échantillon équilibré** sur ces variables.
- Les plans équilibrés permettent :
  - une **meilleure précision** des estimateurs,
  - tout en conservant une **taille fixe**,
